 ...
 */
function scrum_root_relative_url($input) {
...
if (scrum_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'scrum_root_relative_url');
}
